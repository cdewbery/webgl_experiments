...
var Terrain = Object.create(Object, {
    ...
    generateVerticesFromHeightMap: {
        value: function (heightMap, width, length) {
            ...
            //  (0,H,0)   0,  1,   2,   3  (4,H,0) <-- (x,y,z) where H is height
            //            4,  5,   6,   7
            //            8,  9,   10, 11
    ...
    generateTriangleStripIndices: {
        value: function(width, length) {
            ...
            //       right to left
            //            |/|/|/|   0,4,1,5,2,6,3,7     
            //            |\|\|\|   7,11,6,10,5,9,4,8 (7 is indexed twice "degenerate", so we can wrap the line cleanly)   
            //
            //       left to right
            //            |/|/|/|   0,4,1,5,2,6,3,7     
            //            |\|\|\|   7,11,6,10,5,9,4,8
            //            |/|/|/|   8,12,9,13,10,14,11,15 (8 is also index twice)     
            //            
